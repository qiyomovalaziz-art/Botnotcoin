...
DATA_FILE = "data.json"
BOT_TOKEN = os.getenv("TG_BOT_TOKEN")  # yoki to'g'ridan-to'g'ri yozing (xavfsizlik uchun env tavsiya)
ADMIN_ID = int(os.getenv("ADMIN_ID", "0"))  # admin telegram id sini o'rnating
